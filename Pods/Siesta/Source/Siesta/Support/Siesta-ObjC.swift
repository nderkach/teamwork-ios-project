...
public class _objc_Entity: NSObject {
    ...
    @objc public convenience init(content: AnyObject, contentType: String) { self.init(content: content, contentType: contentType, headers: [:]) }
    ...
    @objc public func header(_ key: String) -> String? { return headers[key.lowercased()] }

    @objc public override var description: String { return debugStr(Entity<Any>.convertedFromObjc(self)) }
    }
...
public class _objc_Error: NSObject {
    ...
    internal init(_ error: RequestError) {
        ...
        if let errorData = error.entity { self.entity = _objc_Entity(errorData) }
        }
    }

public extension Service {
    @objc(resourceWithAbsoluteURL:)
    public final func _objc_resourceWithAbsoluteURL(absoluteURL url: URL?) -> Resource { return resource(absoluteURL: url) }

    @objc(resourceWithAbsoluteURLString:)
    public final func _objc_resourceWithAbsoluteURLString(absoluteURL url: String?) -> Resource { return resource(absoluteURL: url) }
    }

public extension Resource {
    @objc(latestData)
    public var _objc_latestData: _objc_Entity? {
        if let latestData = latestData { return _objc_Entity(latestData) } else { return nil }
        }

    @objc(latestError)
    public var _objc_latestError: _objc_Error? {
        if let latestError = latestError { return _objc_Error(latestError) } else { return nil }
        }

    @objc(jsonDict)
    public var _objc_jsonDict: NSDictionary { return jsonDict as NSDictionary }

    @objc(jsonArray)
    public var _objc_jsonArray: NSArray { return jsonArray as NSArray }

    @objc(text)
    public var _objc_text: String { return text }

    @objc(overrideLocalData:)
    public func _objc_overrideLocalData(_ entity: _objc_Entity) { overrideLocalData(with: Entity<Any>.convertedFromObjc(entity)) }
    }
...
public class _objc_Request: NSObject {
    ...
    fileprivate init(_ request: Request) { self.request = request }
    ...
    @objc public func cancel() { request.cancel() }

    @objc public override var description: String { return debugStr(request) }
    }

public extension Resource {
    @objc(load)
    public func _objc_load() -> _objc_Request { return _objc_Request(load()) }

    @objc(loadIfNeeded)
    public func _objc_loadIfNeeded() -> _objc_Request? {
        if let req = loadIfNeeded() { return _objc_Request(req) } else { return nil }
        }
    }
...
private class _objc_ResourceObserverGlue: ResourceObserver, CustomDebugStringConvertible {
    ...
    init(objcObserver: _objc_ResourceObserver) { self.objcObserver = objcObserver }

    deinit {
        if let resource = resource { objcObserver.stoppedObservingResource?(resource) }
        }

    func resourceChanged(_ resource: Resource, event: ResourceEvent) {
        if case .observerAdded = event { self.resource = resource }
        objcObserver.resourceChanged(resource, event: event._objc_stringForm)
        }

    func resourceRequestProgress(_ resource: Resource, progress: Double) { objcObserver.resourceRequestProgress?(resource, progress: progress) }

    var observerIdentity: AnyHashable { return ObjectIdentifier(objcObserver) }

    var debugDescription: String { return debugStr(objcObserver) }
    }

extension ResourceEvent {
    public var _objc_stringForm: String {
        if case .newData(let source) = self { return "NewData(\(source.description.capitalized))" } else { return String(describing: self).capitalized }
        }
    }

public extension Resource {
    @objc(addObserver:)
    public func _objc_addObserver(_ observerAndOwner: _objc_ResourceObserver & AnyObject) -> Self { return addObserver(_objc_ResourceObserverGlue(objcObserver: observerAndOwner), owner: observerAndOwner) }

    @objc(addObserver:owner:)
    public func _objc_addObserver(_ objcObserver: _objc_ResourceObserver, owner: AnyObject) -> Self { return addObserver(_objc_ResourceObserverGlue(objcObserver: objcObserver), owner: owner) }
    ...
    public func _objc_addObserver(owner: AnyObject, block: @escaping @convention(block) (Resource, String) -> Void) -> Self {
        return addObserver(owner: owner) { block($0, $1._objc_stringForm) }
        }
    }
...
public extension Resource {
    ...
    public func _objc_request(
        ...
        return _objc_wrapRequest(method) {
            request($0) { Resource.apply(requestMutation: requestMutation, to: &$0) }
            }
        }
    ...
    public func _objc_request(_ method: String)
        -> _objc_Request {
        return _objc_wrapRequest(method) { request($0) }
        }
    ...
    public func _objc_request(
        ...
        -> _objc_Request {
        return _objc_wrapRequest(method) {
            request($0, data: data, contentType: contentType) { Resource.apply(requestMutation: requestMutation, to: &$0) }
            }
        }
     ...
     public func _objc_request(
             ...
             text: String)
         -> _objc_Request {
         return _objc_wrapRequest(method) { request($0, text: text) }
         }
     ...
     public func _objc_request(
         ...
         -> _objc_Request {
         return _objc_wrapRequest(method) {
            request($0, text: text, contentType: contentType, encoding: String.Encoding(rawValue: encoding)) { Resource.apply(requestMutation: requestMutation, to: &$0) }
            }
         }
     ...
     public func _objc_request(
             ...
             json: NSObject?)
         -> _objc_Request {
         return _objc_wrapJSONRequest(method, json) { request($0, json: $1) }
         }
     ...
     public func _objc_request(
         ...
         return _objc_wrapJSONRequest(method, json) {
            request($0, json: $1, contentType: contentType) { Resource.apply(requestMutation: requestMutation, to: &$0) }
            }
         }
     ...
     public func _objc_request(
         ...
         -> _objc_Request {
         return _objc_wrapRequest(method) {
            request($0, urlEncoded: params) { Resource.apply(requestMutation: requestMutation, to: &$0) }
            }
         }
